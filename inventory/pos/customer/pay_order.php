              ...
              <form method="POST"  enctype="multipart/form-data">
                <div class="form-row">
                  ...
                  <div class="col-md-6">
                    ...
                    <!-- <small class="text-danger"> Type 10 Digits Alpha-Code If Payment Method Is In Cash</small> -->
                    <input type="text" limit="11" name="pay_code" value="<?php echo $mpesaCode; ?>"  class="form-control" value="">
                  </div>
                </div>
                <hr>
                <div class="form-row">
