...
if (isset($_POST['addProduct'])) {
  ...
  if (empty($_POST["prod_code"]) || empty($_POST["prod_name"]) || empty($_POST['prod_desc']) || empty($_POST['prod_price']) || empty($_POST['prod_quantity'])) {
    ...
    $postQuery = "INSERT INTO products (prod_id, prod_code, prod_name, prod_img, prod_desc, prod_price,prod_quantity ) VALUES(?,?,?,?,?,?,?)";
    $postStmt = $mysqli->prepare($postQuery);
    //bind paramaters
    $rc = $postStmt->bind_param('sssssss', $prod_id, $prod_code, $prod_name, $prod_img, $prod_desc, $prod_price, $prod_quantity);
    $postStmt->execute();
        ...
        <div class="col">
          <div class="card shadow">
            ...
            <label>Product Description</label>
                <textarea rows="5" name="prod_desc" class="form-control" oninput="validateTextarea(this, 100)"></textarea>
