              ...
              <form method="POST">
                <div class="form-row">
                  ...
                  <label>Customer Phone Number</label>
                    <input type="text" name="customer_phoneno" id="customer_phoneno" class="form-control" value="">
                      <div id="phoneValidationMsg"></div>
                        </div>
                        <script>

                          // Regex pattern for phone number validation
                     var phoneRegex = /^(750|770|780)\d{7}$/;

                        // Phone number input element
                        var phoneNumberInput = document.getElementById("customer_phoneno");
                        ...
                        function validatePhoneNumber() {
                          ...
                          if (phoneRegex.test(phoneNumber)) {
                            phoneValidationMsg.textContent = ""; // Clear validation message
                          } else {
                            phoneValidationMsg.textContent = "Invalid phone number format. Please enter a 10-digit number starting with 750, 770, or 780.";
                          }
                          }
                        </script>
                </div>
