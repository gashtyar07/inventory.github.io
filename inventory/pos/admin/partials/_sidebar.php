...
<form class="mt-4 mb-3" method="POST" action="search.php">
  <div class="input-group input-group-rounded input-group-merge">
    <input type="text" class="form-control form-control-rounded form-control-prepended" name="search" placeholder="Search" aria-label="Search">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="hrm.php">
              <i class="fas fa-user-tie text-primary"></i> Cashier
            </a>
          </li>
          <li class="nav-item">
